...
class InventorySanityBranch(script: ArceuusLibrary) :
    ...
    private val readyLeaf = InventoryReadyLeaf(script)
    ...
    override val successComponent: TreeComponent<ArceuusLibrary> get() = depositLeaf
    override val failedComponent: TreeComponent<ArceuusLibrary> get() = readyLeaf
}